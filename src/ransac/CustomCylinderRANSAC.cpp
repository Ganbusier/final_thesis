...
#include "CustomCylinderRANSAC.h"
...
std::vector<CylinderPrimitiveShape> CustomCylinderRANSAC::detect(
    easy3d::PointCloud* cloud) {
  std::vector<CylinderPrimitiveShape> detected_cylinders;
